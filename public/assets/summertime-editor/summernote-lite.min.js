        ...
        return (() => {
            ...
            var It = function () {
                function t(e) {
                    !function (t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, t), this.bulvar = new $t, this.options = e.options
                }
            ...
            Rt.where = {Row: 0, Column: 1}, Rt.requestAction = {Add: 0, Delete: 1}, Rt.resultAction = {
                Ignore: 0, SubtractSpanCount: 1, RemoveCell: 2, AddCell: 3, SumSpanCount: 4
            };
            var Lt = function () {
                function t() {
                    !function (t, e) {
                    ...
                    this.insertParagraph = this.wrapCommand((function () {
                        ...
                        if (!(l > 0 && n.isLimited(l))) {
                            ...
                            if (c) {
                                ...
                                nodeName: "A", expandClosestSibling: !0, onlyPartialContains: !0
                            });
                ...
                return o = t, n = [{
                    ...
                    key: "update", value: function (t, o) {
                        ...
                        if (this.context.invoke("imagePopover.update", t, o), n) {
                            ...
                            i.css({
                                display: "block", left: s.left, top: s.top, width: l.w, height: l.h
                            }).data("target", r);
                            var c = new Image;
                            c.src = r.attr("src");
                            ...
                            className: "note-color " + t, children: [this.button({
                                ...
                                click: function (t) {
                                    ...
                                    n && i ? r.context.invoke("editor.color", {
                                        backColor: o.attr("data-backColor"), foreColor: o.attr("data-foreColor")
                    ...
                    key: "addToolbarButtons", value: function () {
                        ...
                        this.context.memo("button.justifyLeft", v.invoke(r, "render")), this.context.memo("button.justifyCenter", v.invoke(a, "render")), this.context.memo("button.justifyRight", v.invoke(s, "render")), this.context.memo("button.justifyFull", v.invoke(l, "render")), this.context.memo("button.outdent", v.invoke(c, "render")), this.context.memo("button.indent", v.invoke(u, "render")), this.context.memo("button.paragraph", (function () {
                            return t.ui.buttonGroup([t.button({
                                ...
                                className: "note-align", children: [r, a, s, l]
                ...
                return o = t, (n = [{
                    ...
                    key: "followScroll", value: function () {
                        ...
                        !this.isFollowing && a > l && a < c - n ? (this.isFollowing = !0, this.$editable.css({marginTop: this.$toolbar.outerHeight()}), this.$toolbar.css({
                            position: "fixed", top: r, width: o, zIndex: 1e3
                        })) : this.isFollowing && (a < l || a > c) && (this.isFollowing = !1, this.$toolbar.css({
                            position: "relative", top: 0, width: "100%", zIndex: "auto"
                ...
                return o = t, (n = [{
                    key: "initialize", value: function () {
                        var t = this.options.dialogsInBody ? this.$body : this.options.container,
                            o = ['<div class="mb-3">', '<label for="note-dialog-link-txt-'.concat(this.options.id, '" class="form-label">').concat(this.lang.link.textToDisplay, "</label>"), '<input id="note-dialog-link-txt-'.concat(this.options.id, '" class="note-link-text form-control" type="text"/>'), "</div>", '<div class="mb-3">', '<label for="note-dialog-link-url-'.concat(this.options.id, '" class="form-label">').concat(this.lang.link.url, "</label>"), '<input id="note-dialog-link-url-'.concat(this.options.id, '" class="note-link-url form-control" type="text" value="http://"/>'), "</div>"].join(""),
                            n = '<input type="button" href="#" class="'.concat("btn btn-primary note-link-btn", '" value="').concat(this.lang.link.insert, '" disabled>');
                        ...
                        if (this.context.invoke("editor.hasFocus")) {
                            ...
                            if (t.isCollapsed() && t.isOnAnchor()) {
                                ...
                                i.top -= r.top, i.left -= r.left, this.$popover.css({
                                    display: "block", left: i.left, top: i.top
                                })
                            } else this.hide()
                        } else this.hide()
                    }
            ...
            var fe = function () {
                ...
                return o = t, (n = [{
                    key: "initialize", value: function () {
                        ...
                        this.$dialog = this.ui.dialog({
                            title: this.lang.image.insert, fade: this.options.dialogsFade, body: i, footer: r
                        }).render().appendTo(n)
                    }
                }, {
                    key: "destroy", value: function () {
                    ...
                    key: "update", value: function (t, o) {
                        if (ht.isImg(t)) {
                            ...
                            this.options.popatmouse ? (r.left = o.pageX - 20, r.top = o.pageY) : r = n, r.top -= i.top, r.left -= i.left, this.$popover.css({
                                display: "block", left: r.left, top: r.top
                            })
                        } else this.hide()
                    }
                }, {
                    ...
                    key: "update", value: function (t) {
                        ...
                        if (o) {
                            ...
                            n.top -= i.top, n.left -= i.left, this.$popover.css({
                                display: "block", left: n.left, top: n.top
                            })
                        } else this.hide();
                        return o
                    }
            ...
            var ke = function () {
                ...
                return o = t, (n = [{
                    key: "initialize", value: function () {
                        ...
                        this.$dialog = this.ui.dialog({
                            title: this.lang.video.insert, fade: this.options.dialogsFade, body: e, footer: o
                        }).render().appendTo(t)
                    }
                }, {
                    key: "destroy", value: function () {
                ...
                return o = t, (n = [{
                    ...
                    key: "update", value: function (t) {
                        ...
                        if (!o.range || o.range.isCollapsed() && !t) this.hide(); else {
                            ...
                            n.top -= i.top, n.left -= i.left, this.$popover.css({
                                display: "block", left: Math.max(n.left, 0) + -5, top: n.top + 5
                ...
                return o = t, n = [{
                    ...
                    key: "initialize", value: function () {
                        ...
                        this.lastWordRange = null, this.matchingWord = null, this.$popover = this.ui.popover({
                            className: "note-hint-popover", hideArrow: !0, direction: ""
                        ...
                        if (!y.contains([wt.code.ENTER, wt.code.UP, wt.code.DOWN], t.keyCode)) {
                            ...
                            if (this.hints.length && i) {
                                ...
                                a && (a.top -= s.top, a.left -= s.left, this.$popover.hide(), this.lastWordRange = n, this.hints.forEach((function (t, e) {
                                    ...
                                    left: a.left, top: a.top - this.$popover.outerHeight() - 5
            ...
            const Re = function () {
                ...
                return o = t, (n = [{
                    key: "show", value: function () {
                        ...
                        "bottom" === a ? i.css({
                            top: o.top + l, left: o.left + (s / 2 - c / 2)
                        }) : "top" === a ? i.css({
                            top: o.top - u, left: o.left + (s / 2 - c / 2)
                        }) : "left" === a ? i.css({
                            top: o.top + (l / 2 - u / 2), left: o.left - c
            ...
            var Be = Ie('<div class="note-editor note-frame"></div>'),
                ...
                qe = Ie('<button type="button" class="note-btn" tabindex="-1"></button>', (function (t, o) {
                    o && o.tooltip && (t.attr({"aria-label": o.tooltip}), t.data("_lite_tooltip", new Re(t, {
                        title: o.tooltip, container: o.container
                    })).on("click", (function (t) {
                    ...
                    return Ve([qe({
                        ...
                        className: t.className, items: t.items, template: t.template, itemClick: t.itemClick
                    })], {callback: e}).render()
                }, Xe = function (t, e) {
                    return Ve([qe({
                        className: "dropdown-toggle",
                    ...
                    return Ve([qe({
                        ...
                        className: "note-list", children: t.items[1]
                    })])]).render()
                }, Je = function (t) {
                    return Ve([qe({
                        className: "dropdown-toggle",
                        ...
                        callback: function (o) {
                            o.find(".note-dimension-picker-mousecatcher").css({
                                width: t.col + "em", height: t.row + "em"
                    ...
                    return Ve({
                        className: "note-color", children: [qe({
                            className: "note-current-color-button",
                            contents: t.title,
                ...
                oo = Ie('<div class="modal" aria-hidden="true" tabindex="-1" id="linkModal"></div>', (function (t, e) {
                    e.fade && t.addClass("fade"), t.attr({"aria-label": e.title}), t.html(['<div class="modal-dialog modal-dialog-centered"><div class="modal-content">', e.title ? '<div class="modal-header"><h4 class="modal-title fs-5">' + e.title + '</h4></div>' : "", '<div class="modal-body">' + e.body + "</div>", e.footer ? '<div class="modal-footer">' + e.footer + "</div>" : "", "</div></div>"].join("")), t.data("modal", new He(t, e))
                })),
